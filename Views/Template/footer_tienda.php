		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<p>
						<h7>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
							Velit nobis voluptate modi? Reiciendis quis quaerat, voluptatibus ea 
							delectus ad odio id debitis nemo laboriosam ratione asperiores placeat fugiat 
							incidunt nihil.
						</h7>
					</p>
